...
If running on AMD GPU, tried below steps to install sglang for rocm or just run in rocm docker from [docker hub](https://hub.docker.com/r/rocm/sgl-dev) directly
```bash
...
python -m sglang.launch_server \
    ...
    --mooncake-ib-device <mooncake-ib-device> \
